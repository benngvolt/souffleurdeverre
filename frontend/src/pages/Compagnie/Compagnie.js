...
function Compagnie() {
    ...
    return  (      
        <section className='compagnie'>
            ...
            <img src="assets/Julien_Rocha_Julien_Bruhat.jpg" alt="logo souffleur de verre"/>
            <ul>
                <li>
