    ...
    return  (      
        <section className='compagnieSection'>
            ...
            <div className='compagnieSection_intro'>
                <p> La Compagnie Le Souffleur de Verre a vu le jour en Auvergne en juillet 2003.Sa responsabilité artistique est assumée par Julien Rocha et Cédric Veschambre, à la fois metteurs en scène et acteurs.En résidence à Cournon d’Auvergne 2004/11, à Monistrol sur Loire 2012/15, associée à la Comédie de Saint-Étienne 2013/16, Artiste Associée et responsable de l’École du jeune spectateur au Caméléon, scène labellisée pour l’émergence et la création en Auvergne-Rhône-Alpes 2020/23.<br/>
                    ...
                    Déployer ainsi des problématiques qui appartiennent au monde et faire du plateau, un lieu de l’écrit, un lieu de parole et un lieu de plaisir qui s’adresse à tous.<br/>
                </p>
                <p> Vers un théâtre de l’anomalie ?<br/>
            ...
            <div className='compagnieSection_intro'>
                <p>Ainsi, c’est un théâtre épique que nous défendons qui cultive l’étrangeté, convoque d’autres univers, nouveaux projecteurs qui illuminent différemment notre réalité. Le récit dramaturgique, ainsi projeté dans d’autres mondes, échappe à la linéarité et à l’interprétation univoque.<br/>
